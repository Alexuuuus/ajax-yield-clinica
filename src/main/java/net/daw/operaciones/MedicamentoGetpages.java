 ...
 * @author VICENTE
 */
public class MedicamentoGetpages implements GenericOperation{
   @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            MedicamentoDao dao = new MedicamentoDao(Conexion.getConection(),"historiales");
            int pages = dao.getPages(rpp, alFilter, hmOrder);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("MedicopagesJson: View Error: " + e.getMessage());
        }
    } 
}
