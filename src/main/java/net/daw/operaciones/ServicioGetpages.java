 ...
 * @author VICENTE
 */
public class ServicioGetpages implements GenericOperation {
     @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            ServicioDao dao = new ServicioDao(Conexion.getConection(),"sevicio");
            int pages = dao.getPages(rpp, alFilter, hmOrder);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("ServiciopagesJson: View Error: " + e.getMessage());
        }
    }
}
