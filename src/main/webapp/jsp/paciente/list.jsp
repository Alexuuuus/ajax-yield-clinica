<%-- 
    Document   : list
    Created on : 24-febrero-2014, 04:35:33
    Author     : Alejandro
--%>

<%@page import="net.daw.helper.Conexion"%>
<%@page import="net.daw.dao.PacienteDao"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.Iterator"%>
<%
    PacienteDao dao = new PacienteDao(Conexion.getConection(),"pacientes");
    ArrayList<String> alColumnsNames = (ArrayList<String>) dao.getColumnsNames();
    Iterator<String> oIterador = alColumnsNames.listIterator();
    String strNombreMantenimiento = "paciente";
%>
